...
// ENSURE A HOOK START WITH THE WORD 'use'
if (!hookName.startsWith("use")) {
    console.error("Hook name should start with the word 'use'. Please provide a name starting with 'use'. For example, 'useLocalStorage'.");
    // eslint-disable-next-line no-undef
    process.exit(1);
}
