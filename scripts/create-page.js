...
// Check if page name contains the word "Page"
if (pageName.includes("Page") || pageName.includes("page")) {
    console.error(
        "Page name should not contain the word 'Page'. Please provide a name without the word 'Page'."
    );
    // eslint-disable-next-line no-undef
    process.exit(1);
}
